...
namespace lib10
{
    ...
    public class Engine : IInit, ICloneable, IComparable<Engine>
    {
        ...
        public Engine(Engine other)
        {
            ...
            Power = other.Power;
            Gender = other.Gender;
            Size = new ForCopy(other.Size.Value);
        }
        ...
        public void RandomInit_Model()
        {
            Model = "Model " + rand.Next(0, 10000).ToString() + rand.Next(0, 10000).ToString();
        }
        ...
        public override int GetHashCode()
        {
            ...
            hash = hash * 31 + (Gender?.GetHashCode() ?? 0);
            return hash;
        }
        public override bool Equals(object obj)
        {
            ...
            {
                return this.Model == otherEngine.Model && this.Power == otherEngine.Power && Gender == otherEngine.Gender;
            }
            return false;
        }
        public override string ToString()
        {
            return $"Model: {Model}, Power: {Power} HP, Gender: {Gender}, Size: {Size?.Value ?? 0}";
        }
    }
}
